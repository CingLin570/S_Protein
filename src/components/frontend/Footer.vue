<template>
  <div class="footer">
    ...
    <div class="bg-white py-5">
      <div class="container">
        <div
          class="d-flex align-items-center justify-content-between text-primary mb-md-7 mb-4"
        >
          <a class="footerLogo font-style text-primary" href="./index.html"
            >S Protein</a
          >
          <ul class="d-flex list-unstyled mb-0 h4">
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100002626446604"
